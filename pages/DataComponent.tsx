    ...
    <React.Fragment>
      <article className="lg:ml-12">
        <Image
          ...
          height={200}
          alt=""
          className="mx-auto lg:mx-0 rounded-2xl md:w-7/12 lg:w-11/12"
        />

        {/* Products Map */}
        <div>
          <ul className="flex flex-wrap items-center justify-center gap-3 mt-5 lg:ml-0 md:gap-5 lg:justify-start md:flex">
